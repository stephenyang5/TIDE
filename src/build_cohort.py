...
separately from CAM-ICU + RASS chart events (see :mod:`src.labeling` and the
extraction notebook), which is the single source of truth for the label.

Example
-------
    python -m src.build_cohort --min-los-hours 24 -o results/cohort_base.csv.gz
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print("NOTE: this cohort is UNLABELED. Assign the delirium label from "
          "CAM-ICU + RASS via src.labeling (see 01_cohort_extraction.ipynb).")
    return 0
